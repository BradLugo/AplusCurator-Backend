...
namespace AplusCurator.Tests.Controllers
{
    ...
    public class StudentControllerTests
    {
        ...
        [Fact]
        public void CanUpdateStudentFirstNameFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentLastNameFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentDateOfBirthForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentGenderFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentCurrentGradeFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentDescriptionFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentStatusFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
        ...
        [Fact]
        public void CanUpdateStudentSystemInfoFromForm()
        {
            // Seed the new context on each test to ensure a clean test environment
            _context = CreateAndSeedContext();
